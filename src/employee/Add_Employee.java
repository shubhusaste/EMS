...
class Add_Employee implements ActionListener{
    ...
    JButton b,b1,b2,b3;
     ...
     public void Emp_Id() {
         try {
             Conn c2 = new Conn();
             String q1 = "select max(EMP_ID) from employee";
            PreparedStatement ps=c2.c.prepareStatement(q1);
             ResultSet rs=ps.executeQuery();
			if(rs.next())
			{
				String n=rs.getString("max(EMP_ID)");
				int n1=Integer.parseInt(n);
		        int n2=n1+1;
	//			System.out.println(n);
				t11.setText(String.valueOf(n2));
			}
         } catch (Exception ee) {
             ee.printStackTrace();

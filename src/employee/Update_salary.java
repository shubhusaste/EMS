...
public class Update_salary extends JFrame implements ActionListener,ItemListener{
    ...
    Update_salary(){
        ...
        try{
            ...
            ResultSet rs1 = c.s.executeQuery("select * from salary");
            while(rs1.next()){
                c2.add(rs1.getString("Emp_id"));
        ...
        JLabel emp = new JLabel("Select Emp. Id");
        ...
        b2.setBounds(150,280,100,20);
        b3.setBounds(260,280,100,20);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            ...
            String qry = "update salary set hra="+hra+",da="+da+",med="+med+",pf="+pf+",basic_salary="+basic+"  where Emp_id="+c2.getSelectedItem();
        ...
        if(ae.getSource()==b2){
            ...
            try{
                Conn c1 = new Conn();
                c1.s.executeUpdate("delete from salary where Emp_id="+c2.getSelectedItem());
    ...
    public void itemStateChanged(ItemEvent ie)
    {
        try{
            Conn c1 = new Conn();
            ResultSet rs = c1.s.executeQuery("select * from salary where Emp_id="+c2.getSelectedItem());
            if(rs.next()){
